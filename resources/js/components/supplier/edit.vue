            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form method="post" class="user" @submit.prevent="supplierUpdate" enctype="multipart/form-data">  
...
created() {
    ...
    axios.get('/api/edit-supplier/' +id)
...
methods:{
    supplierUpdate() {
        let id = this.$route.params.id
        axios.post('/api/update-supplier/'+id, this.form)
        .then(() => {
