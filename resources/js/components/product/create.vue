            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form method="post"  class="user" @submit.prevent="productInsert" enctype="multipart/form-data">  
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <select v-model="form.supplier_id" class="form-select" id="exampleFormControlSelect1">
...
methods:{
    productInsert() {
        axios.post('/api/store-product', this.form)
        .then(() => {
